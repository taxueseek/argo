...
SOURCE_TYPE_MAP = {
    ...
    "pypi": ("包注册表", 0.88),
    "npm": ("包注册表", 0.88),
    "huggingface": ("模型仓库", 0.85),
    "docker_hub": ("容器镜像", 0.8),
    "juejin": ("中文技术社区", 0.65),
    "devto": ("技术社区", 0.65),
    "clinicaltrials": ("临床试验注册", 0.9),
    "openfda": ("药品标签", 0.88),
    "archive_org": ("数字档案馆", 0.75),
    "steam": ("游戏商店", 0.7),
    "polymarket": ("预测市场叙事", 0.35),
    "anysearch": ("垂直搜索", 0.75),
    ...
    "finviz": ("美股快照", 0.75),
    "seeking_alpha": ("美股分析", 0.7),
    "jin10": ("财经快讯", 0.65),
    "models_dev": ("模型目录", 0.85),
    "octen": ("AI搜索", 0.7),
    "qweather": ("天气数据", 0.9),
    "wenshu": ("裁判文书", 0.75),
